...
<p class="mt-5" style="color: #636b6f;font-family: 'Nunito', sans-serif;font-weight: 200; font-size: 30px; text-align:center;"> Votre historique de location de vehicule:   </p>
...
@isset($myRents)
    @if(count($myRents) == 0 AND Auth::check() == true)
        <div class="alert alert-danger text-center mt-5" style="width: 30%; margin-left: 35%; text-align:center; " role="alert">
            Vous n'avez eu aucune location 
        </div>
    @endif
@endisset
