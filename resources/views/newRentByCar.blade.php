...
<p style="color: #636b6f;font-family: 'Nunito', sans-serif;font-weight: 200; font-size: 30px; text-align:center;">{{$unvehicle->marque}}, {{$unvehicle->modele}}</p>
    ...
    <div class="container" style=" font-size: 20px;"> 
      <div class="row" style="text-align:center">
          <div class="col-lg-12" >
                  ...
                  <div class="card">
                  <img src="../../assets/{{$unvehicle->photo}}.jpg" class="card-img-top" alt="...">
                          <div class="card-body">
